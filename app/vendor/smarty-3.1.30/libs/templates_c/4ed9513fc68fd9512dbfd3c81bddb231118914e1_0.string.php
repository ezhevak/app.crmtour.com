<?php
/* Smarty version 3.1.30, created on 2018-01-14 17:24:05
  from "4ed9513fc68fd9512dbfd3c81bddb231118914e1" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5a5b7615010443_11643035',
...
function content_5a5b7615010443_11643035 (Smarty_Internal_Template $_smarty_tpl) {
?>
<p>&nbsp;</p>
<table style="border-color: #034c85; background-color: #f7feff;" width="717">
<tbody>
<tr style="height: 50px;">
<td style="width: 408px; height: 50px;" colspan="2" width="40">&nbsp;Постачальник</td>
<td style="width: 666px; height: 50px;" colspan="4" width="504">ФОП Саввіна Христина Борисівна</td>
</tr>
<tr style="height: 50px;">
<td style="width: 408px; height: 200px;" colspan="2" rowspan="4" width="40">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
<td style="width: 268px; height: 50px;" colspan="2" width="221"><em>ЄДРПОУ <?php echo $_smarty_tpl->tpl_vars['account']->value['BankCode'];?>
</em></td>
<td style="width: 398px; height: 50px;" colspan="2" width="283"><em>т/ф&nbsp;<?php echo $_smarty_tpl->tpl_vars['account']->value['OfficePhone'];?>
</em></td>
</tr>
<tr style="height: 50px;">
<td style="width: 666px; height: 50px;" colspan="4" width="504"><em>Р/р <?php echo $_smarty_tpl->tpl_vars['account']->value['BankAccount'];?>
 у ПАТ КБ "ПРИВАТБАНК"</em></td>
</tr>
<tr style="height: 50px;">
<td style="width: 666px; height: 50px;" colspan="4" width="504"><em>Є платником єдиного податку, 3 група, 5%, не платник ПДВ</em></td>
</tr>
<tr style="height: 50px;">
<td style="width: 666px; height: 50px;" colspan="4" width="504"><em>Поштова.адреса: <?php echo $_smarty_tpl->tpl_vars['account']->value['OfficeAddress'];?>
</em></td>
</tr>
<tr style="height: 50px;">
<td style="width: 408px; height: 50px;" colspan="2" width="40">&nbsp;Одержувач</td>
<td style="width: 666px; height: 50px;" colspan="4" width="504"><strong>ФОП Саввіна Христина Борисівна</strong></td>
</tr>
<tr style="height: 50px;">
<td style="width: 408px; height: 50px;" colspan="2" width="40">&nbsp;Платник</td>
<td style="width: 666px; height: 50px;" colspan="4" width="171"><?php echo $_smarty_tpl->tpl_vars['data']->value['ContactFullName'];?>
</td>
</tr>
<tr style="height: 50px;">
...
<tr style="height: 50px;">
<td style="width: 408px; height: 50px;" colspan="2" width="40">
<p>&nbsp;Договір №</p>
</td>
<td style="width: 666px; height: 50px;" colspan="4" width="171">
<p><strong>&nbsp;<?php echo $_smarty_tpl->tpl_vars['data']->value['DealNo'];?>
&nbsp;від <?php echo $_smarty_tpl->tpl_vars['data']->value['DealDate'];?>
</strong></p>
</td>
</tr>
<tr style="height: 50px;">
<td style="width: 408px; height: 100px;" colspan="2" rowspan="2">&nbsp;&nbsp;&nbsp;&nbsp;</td>
<td style="width: 268px; height: 50px;" colspan="2" width="221"><strong>РАХУНОК-ФАКТУРА №&nbsp;</strong></td>
<td style="width: 398px; height: 50px;" colspan="2" width="120"><strong><?php echo $_smarty_tpl->tpl_vars['data']->value['DealNo'];?>
</strong></td>
</tr>
<tr style="height: 50px;">
<td style="width: 268px; height: 50px;" colspan="2" width="221"><strong>Дата рахунку</strong></td>
...
<td style="width: 367px; height: 50px;" width="173"><strong>Назва послуги:</strong></td>
<td style="width: 188px; height: 50px;" width="171"><strong>Од.</strong></td>
...
<td style="width: 367px; height: 136px;" width="173">
...
<td style="width: 188px; height: 136px;" width="171">грн.</td>
...
<tr style="height: 50px;">
<td style="width: 408px; height: 50px;" colspan="2">&nbsp;<strong>Всього на суму:</strong></td>
<td style="width: 666px; height: 50px;" colspan="4" width="504"><?php echo $_smarty_tpl->tpl_vars['data']->value['PrePaySumString'];?>
</td>
</tr>
<tr style="height: 50px;">
