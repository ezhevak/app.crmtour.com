<?php
/* Smarty version 3.1.30, created on 2020-01-28 11:45:02
  from "83308466690b77e15e330945384c85135e3ea0ff" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5e30029ee0b2c9_49823598',
...
function content_5e30029ee0b2c9_49823598 (Smarty_Internal_Template $_smarty_tpl) {
?>
<p>&nbsp;</p>
...
<td style="height: 49px; width: 329px;" colspan="2" width="128">ЄДРПОУ&nbsp; <?php echo $_smarty_tpl->tpl_vars['account']->value['BankCode'];?>
</td>
<td style="height: 49px; width: 575px;" colspan="2" width="128">т/ф <?php echo $_smarty_tpl->tpl_vars['account']->value['OfficePhone'];?>
&nbsp;</td>
</tr>
<tr style="height: 66px;">
<td style="height: 66px; width: 904px;" colspan="4" width="256">IBAN: <?php echo $_smarty_tpl->tpl_vars['account']->value['BankIban'];?>
...
<tr style="height: 49px;">
<td style="height: 49px; width: 904px;" colspan="4" width="256">Платник податку на загальних підставах</td>
</tr>
<tr style="height: 49px;">
<td style="height: 49px; width: 904px;" colspan="4" width="256">Поштова.адреса: <?php echo $_smarty_tpl->tpl_vars['account']->value['FactAddress'];?>
</td>
</tr>
<tr style="height: 49px;">
<td style="height: 49px; width: 398px;" colspan="2" width="328">&nbsp;Одержувач</td>
<td style="height: 49px; width: 904px;" colspan="4" width="256">&nbsp;<?php echo $_smarty_tpl->tpl_vars['data']->value['ContactFullName'];?>
</td>
</tr>
<tr style="height: 49px;">
<td style="height: 49px; width: 398px;" colspan="2" width="328">&nbsp;Платник</td>
<td style="height: 49px; width: 904px;" colspan="4" width="256">той самий&nbsp;&nbsp;&nbsp;</td>
</tr>
<tr style="height: 49px;">
<td style="height: 49px; width: 1302px;" colspan="6" width="584">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
</tr>
<tr style="height: 49px;">
<td style="height: 49px; width: 398px;" colspan="2" width="328">&nbsp;Договір №</td>
<td style="height: 49px; width: 904px;" colspan="4" width="256">&nbsp;<?php echo $_smarty_tpl->tpl_vars['data']->value['DealNo'];?>
&nbsp;&nbsp;&nbsp;</td>
</tr>
<tr style="height: 49px;">
<td style="height: 98px; width: 398px;" colspan="2" rowspan="2" width="328">&nbsp;&nbsp;&nbsp;&nbsp;</td>
<td style="height: 49px; width: 329px;" colspan="2" width="128">РАХУНОК-ФАКТУРА №&nbsp;</td>
<td style="height: 49px; width: 575px;" colspan="2" width="128">&nbsp;<?php echo $_smarty_tpl->tpl_vars['data']->value['DealNo'];?>
&nbsp;</td>
</tr>
<tr style="height: 49px;">
<td style="height: 49px; width: 329px;" colspan="2" width="128">Дата рахунку</td>
<td style="height: 49px; width: 575px;" colspan="2" width="128">&nbsp;<?php echo $_smarty_tpl->tpl_vars['data']->value['DealDate'];?>
&nbsp;</td>
</tr>
<tr style="height: 49px;">
<td style="height: 49px; width: 94px;" width="190">№</td>
<td style="height: 49px; width: 304px;" width="138">Назва послуги:</td>
<td style="height: 49px; width: 213px;" width="64">Од.</td>
...
<tr style="height: 49px;">
<td style="height: 49px; width: 94px;" width="190">1</td>
<td style="height: 49px; width: 304px;" width="138">За туристичні послуги, без ПДВ.</td>
<td style="height: 49px; width: 213px;" width="64">грн.</td>
...
<tr style="height: 66px;">
<td style="height: 66px; width: 94px;" width="190">2</td>
<td style="height: 66px; width: 304px;" width="138">За послуги бронювання, сервісний збір, в т.ч ПДВ</td>
<td style="height: 66px; width: 213px;" width="64">пос.</td>
