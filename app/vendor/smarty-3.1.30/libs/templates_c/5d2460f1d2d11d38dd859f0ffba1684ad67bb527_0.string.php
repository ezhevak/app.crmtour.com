<?php
/* Smarty version 3.1.30, created on 2018-05-07 14:31:29
  from "5d2460f1d2d11d38dd859f0ffba1684ad67bb527" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5af03911ba1979_74191276',
...
function content_5af03911ba1979_74191276 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
, назване у подальшому &laquo;Турагент&raquo; (розмір фінансової гарантії відповідальності Турагента складає еквівалент суми 2000&nbsp;Євро, яка надана&nbsp; "Глобус Банк", згідно Договору про надання банківської гарантії виконання зобов&rsquo;язань №4122-г&nbsp;від 12/07/2017 р.), в особi <?php echo $_smarty_tpl->tpl_vars['account']->value['DirectorName'];?>
, що діє на підставі Державної реєстрації, який діє від імені та за дорученням&nbsp; ТОВ "Мережа магазинiв горящих путiвок" через ТОB &laquo;Туристична Компанія &laquo;Анекс Тур&raquo; (адреса: 02121, м. Київ, вул. Харківське шосе, 201-203,2А, група нежилих прим.№53,офіс № 1, тел.&nbsp;(044) 591 1 591, ліцензія на право заняття туроператорською діяльністю Серія AГ № 581096 від 17 травня 2012 року) на підставі Договору №&nbsp; № 145/17 вiд 20.07.2017р, з одного боку та <?php echo $_smarty_tpl->tpl_vars['data']->value['ContactFullName'];?>
...
<p>&nbsp;</p>
<p><span style="text-align: justify;">2.3. Термін подорожі: з <?php echo $_smarty_tpl->tpl_vars['data']->value['DateArrival'];?>
