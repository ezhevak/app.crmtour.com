<?php
/* Smarty version 3.1.30, created on 2017-08-23 16:30:17
  from "00348ecdd5e216ad2431ca20afaa5ad45bfa33c8" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_599d8369228844_55210238',
...
function content_599d8369228844_55210238 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
<p>Турагентом ФОП Ладигіна М.І в особі директора Ладигіної М. І, Гарантія виконання зобов&rsquo;язань № 1059, Фінансове забезпечення цивільної відповідальності Турагента перед туристами становить суму еквівалентну 2000 ЄВРО згідно з офіційним курсом НБУ в ПАТ &laquo;КОМЕРЦІЙНИЙ БАНК &laquo;ГЛОБУС&raquo; що діє на підставі Агентського договору на реалізацію &nbsp;турпродукту від імені та за дорученням Туроператора<strong> Товариство з обмеженою відповідальністю &laquo;Джоін </strong><strong>АП</strong><strong>!&raquo;</strong>, (надалі &ndash; <strong>Туроператор</strong>) (ліцензія № 1597 видана Міністерством економічного розвитку і торгівлі 04.12.2015 року., діє безстроково, розмір фінансового забезпечення ТУРОПЕРАТОРА складає 20 000 (двадцять тисяч) ЄВРО), що знаходиться за адресою: 02121, м. Київ, вул. Харківське шосе, буд. 201-203, літ. 2 А, код ЄДРПОУ 38729427), в особі Виконавчого директора Сєроухова Д.Г, який діє на підставі Статуту, і &nbsp;Громадянин (ка)&nbsp;<?php echo $_smarty_tpl->tpl_vars['data']->value['ContactFullName'];?>
...
<p><strong style="text-align: justify;">&lt;table&gt;<br />&lt;thead&gt;<br />&lt;tr&gt;<br /> &lt;th&gt;Имя&lt;/th&gt;<br /> &lt;th&gt;Фамилия&lt;/th&gt;<br /> &lt;th&gt;Дата рождения&lt;/th&gt;<br /> &lt;th&gt;Тип документа&lt;/th&gt;<br /> &lt;th&gt;First Name&lt;/th&gt;<br /> &lt;th&gt;Last Name&lt;/th&gt;<br /> &lt;th&gt;Серия номер&lt;/th&gt;<br /> &lt;th&gt;Действующий&lt;/th&gt;<br /> &lt;th&gt;Кем выдан&lt;/th&gt;<br />&lt;/tr&gt;<br />&lt;/thead&gt;<br /><?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['data_ext']->value['contactmembers'], 'contact', false, NULL, 'outer', array (
));
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['contact']->value) {
...
?>
<br />&lt;/table&gt;</strong></p>
<p><strong style="text-align: justify;">Істотні умови договору</strong></p>
