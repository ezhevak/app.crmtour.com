<?php
/* Smarty version 3.1.30, created on 2018-11-02 13:27:59
  from "5568cd1229fc9c01eb0b5d5175f4de2cf4356f96" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5bdc34bf439cb1_29710122',
...
function content_5bdc34bf439cb1_29710122 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
&nbsp;<?php echo $_smarty_tpl->tpl_vars['contact']->value['documents'][0]['Valid'];?>
 <?php echo $_smarty_tpl->tpl_vars['contact']->value['documents'][0]['IssuedBy'];?>
&nbsp;(паспорт, серія, номер, ким виданий), який діє за усним дорученням від імені інших туристів:</p>
<pre>&lt;table&gt;
&lt;thead&gt;
&lt;tr&gt;
	&lt;th&gt;Имя&lt;/th&gt;
...
<p style="text-align: justify;"><strong>11) загальна вартість туристичного обслуговування згідно комерційного курсу туроператора (<?php echo $_smarty_tpl->tpl_vars['data']->value['DealCurrencyName'];?>
=<?php echo $_smarty_tpl->tpl_vars['data']->value['CommercialCourse'];?>
) становить: <?php echo $_smarty_tpl->tpl_vars['data']->value['DealSum'];?>
 <?php echo $_smarty_tpl->tpl_vars['data']->value['DealSumString'];?>
.&nbsp; Доплата здійснюється у гривнях згідно з комерційним курсом туроператора на день доплати.&nbsp;</strong></p>
...
<p style="text-align: justify;">- за відмову від поїздки в терміни 30-21 день до початку подорожі - 30% загальної вартості туристичних послуг;</p>
<p style="text-align: justify;">- за відмову від поїздки в терміни 20-15 днів до початку подорожі - 65% загальної вартості туристичних послуг;</p>
<p style="text-align: justify;">- за відмову від поїздки в терміни 14-8 днів до початку подорожі &ndash; 100 % загальної вартості туристичних послуг;</p>
