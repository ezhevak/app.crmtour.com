<?php
/* Smarty version 3.1.30, created on 2018-08-23 15:56:56
  from "a3dd7bcb62313d2bcf17679848e17fdbe1663ea2" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5b7eaf18b3c450_45291093',
...
function content_5b7eaf18b3c450_45291093 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
<p style="text-align: justify;">м. Чернівці&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<?php echo $_smarty_tpl->tpl_vars['data']->value['DealDate'];?>
 р.</p>
<p style="text-align: justify;"><?php echo $_smarty_tpl->tpl_vars['account']->value['Name'];?>
, назване у подальшому &laquo;Турагент&raquo; (розмір фінансової гарантії відповідальності Турагента складає еквівалент суми 20 000&nbsp;Євро, яка надана ПАТ "Банк інвестицій та заощаджень, згідно Договору про надання банківської гарантії виконання зобов&rsquo;язань №514/16-г&nbsp;від 01/03/2017 р.), в особі <?php echo $_smarty_tpl->tpl_vars['account']->value['DirectorName'];?>
, що діє на підставі Статуту, який діє від імені та за дорученням Туроператора ТОВ &laquo;Туристична Компанія &laquo;Анекс Тур&raquo; (адреса: 02121, м. Київ, вул. Харківське шосе, 201-203,2А, група нежилих прим.№53,офіс № 1, тел.&nbsp;(044) 591 1 591, ліцензія на право заняття туроператорською діяльністю Серія AГ № 581096 від 17 травня 2012 року) на підставі Договору №&nbsp;<?php echo $_smarty_tpl->tpl_vars['data']->value['OperatorDealNum'];?>
 &nbsp;від <?php echo $_smarty_tpl->tpl_vars['data']->value['DealDateStart'];?>
 р., з одного боку та <?php echo $_smarty_tpl->tpl_vars['data']->value['ContactFullName'];?>
...
&nbsp;(ання подорожі за системою &laquo;Рулетка&raquo;, вказується назва &laquo;Roulette&raquo; та категорія без назви готелю)</p>
...
<p style="text-align: justify;">2.7. Трансфер: <?php echo $_smarty_tpl->tpl_vars['data']->value['TransferName'];?>
 Харчування<span style="color: #626262;">вказується: вид транспортного засобу (літак, потяг, автобус, автомобіль); маршрут)</span></p>
...
<p style="text-align: justify;"><span style="color: #626262;">(вказується: назва готелю; категорія; тип номеру; в разі обр</span>: <?php echo $_smarty_tpl->tpl_vars['data']->value['FeedName'];?>
...
<p style="text-align: justify;">3.1. <span style="font-size: 10pt;">Загальна вартість послуг складає:<strong><?php echo $_smarty_tpl->tpl_vars['data']->value['DealSum'];?>
...
<li><strong><u> АДРЕСИ СТОРІН</u></strong>
<table>
<tbody>
<tr>
