<?php
/* Smarty version 3.1.30, created on 2018-08-23 16:02:49
  from "6bae50230690527e3ad40a6a73c236555350e8cd" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5b7eb07985d937_01822672',
...
function content_5b7eb07985d937_01822672 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
<p style="text-align: justify;">Громадянин (ка<strong>)&nbsp;<?php echo $_smarty_tpl->tpl_vars['data']->value['ContactFullName'];?>
, <?php echo $_smarty_tpl->tpl_vars['data']->value['ukrSeriaNum'];?>
&nbsp;</strong>(паспорт, серія, номер, ким виданий, коли, адреса реєстрації, ідентифікаційний номер, також дані всіх повнолітніх та неповнолітніх осіб, які приймають участь у турі, в т.ч. й самого замовника, якщо він також є Туристом), який діє за усним дорученням від імені інших туристів:</p>
<p><?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['data_ext']->value['contactmembers'], 'contact', false, NULL, 'outer', array (
));
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['contact']->value) {
?>Громодянин(ка)<strong> <?php echo $_smarty_tpl->tpl_vars['contact']->value['FirstName'];?>
...
<p style="text-align: justify;"><br />1) строк перебування у місці надання туристичних послуг із зазначенням дат початку та закінчення туристичного обслуговування<strong> <?php echo $_smarty_tpl->tpl_vars['data']->value['DateArrival'];?>
 - <?php echo $_smarty_tpl->tpl_vars['data']->value['DateDeparture'];?>
;</strong></p>
<p style="text-align: justify;">2) характеристика транспортних засобів, що здійснюють перевезення, зокрема їх вид і категорія, а також дата, час і місце відправлення та повернення (якщо перевезення входить до складу туристичного продукту) <strong><?php echo $_smarty_tpl->tpl_vars['data']->value['Transport'];?>
...
;</strong></p>
<p style="text-align: justify;">3) готелі та інші аналогічні засоби розміщення, їх місце розташування, категорія, а також відомості про підтвердження відповідності послуг готелю встановленим вимогам, строк і порядок оплати готельного обслуговування <strong><?php echo $_smarty_tpl->tpl_vars['data']->value['DirectionName'];?>
...
;</strong></p>
<p style="text-align: justify;">4) види і способи забезпечення харчування<strong> <?php echo $_smarty_tpl->tpl_vars['data']->value['FeedName'];?>
;</strong></p>
...
<p style="text-align: justify;">9) страховик, що здійснює обов&rsquo;язкове та/або добровільне страхування туристів за бажанням туриста, інших ризиків, пов&rsquo;язаних з наданням туристичних послуг <strong><?php echo $_smarty_tpl->tpl_vars['data']->value['Insurance'];?>
;</strong></p>
...
<p style="text-align: justify;">11) <span style="font-size: 10pt;">Загальна вартість послуг складає<strong>:<?php echo $_smarty_tpl->tpl_vars['data']->value['DealSum'];?>
...
<table style="height: 515px;" width="1308">
<tbody>
<tr>
