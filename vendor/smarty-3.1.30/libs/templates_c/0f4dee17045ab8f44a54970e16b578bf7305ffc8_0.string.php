<?php
/* Smarty version 3.1.30, created on 2020-02-24 12:21:51
  from "0f4dee17045ab8f44a54970e16b578bf7305ffc8" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5e53a3bf0629e6_02844034',
...
function content_5e53a3bf0629e6_02844034 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
, назване у подальшому &laquo;Турагент&raquo; (розмір фінансової гарантії відповідальності Турагента складає еквівалент суми 2000&nbsp;Євро, яка надана ПАТ "Банк інвестицій та заощаджень, згідно Договору про надання банківської гарантії виконання зобов&rsquo;язань №11617/17-Г від 15/09/2017 р.), в особі <?php echo $_smarty_tpl->tpl_vars['account']->value['DirectorName'];?>
, що діє на підставі&nbsp; виписки з ЄДРПУ, який діє від імені та за дорученням Туроператора ТОВ &laquo;Туристична Компанія &laquo;Анекс Тур&raquo; (адреса: 02121, м. Київ, вул. Харківське шосе, 201-203,2А, група нежилих прим.№53,офіс № 1, тел.&nbsp;(044) 591 1 591, ліцензія на право заняття туроператорською діяльністю Серія AГ № 581096 від 17 травня 2012 року) на підставі Договору № 543 А/14&nbsp; від 21.05.2014 р., з одного боку та <?php echo $_smarty_tpl->tpl_vars['data']->value['ContactFullName'];?>
...
<p style="text-align: justify;">2.3. Термін подорожі: з <?php echo $_smarty_tpl->tpl_vars['data']->value['DateArrival'];?>
 ...
 &nbsp;р.</p>
<p style="text-align: justify;">&nbsp;2.4. Транспортне обслуговування*:&nbsp;</p>
...
&nbsp; &nbsp;Харчування: <?php echo $_smarty_tpl->tpl_vars['data']->value['FeedName'];?>
 &nbsp;Страховик:&nbsp;<?php echo $_smarty_tpl->tpl_vars['data']->value['Insurance'];?>
</p>
...
<p style="text-align: justify;">2.9. Інші суб'єкти туристичної діяльності, які надають туристичні послуги, включені до туристичного продукту (у тому числі приймаюча сторона): (вказується: їх місцезнаходження та реквізити)___________________________________________________________</p>
...
, сумма предоплати становить&nbsp;<?php echo $_smarty_tpl->tpl_vars['data']->value['PrePaySum'];?>
