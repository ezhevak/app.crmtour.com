		    		...
		    		success : function(json_data) {
		       			...
		       			if (data.selected.length > 0) {
		       				if (opts.data_type == "contact")
		       					text += data.selected[0].LastName + " " + data.selected[0].FirstName;
		       				if (opts.data_type == "legal")
		       					text += data.selected[0].LegalName;
		       			}
		    		},
		    		error: function() {
		    		}
						...
						console.log("send post");
			      		$.ajax({
				    		...
				    		success : function(json_data) { 
				       			...
				       			if (opts.data_type == "contact")
				       				pickThis.find("#" + pickThis.attr("id") + "pickInput").val(rowData.LastName + " " + rowData.FirstName);
				       			if (opts.data_type == "legal")
				       				pickThis.find("#" + pickThis.attr("id") + "pickInput").val(rowData.LegalName);
				    		},
				    		error: function() {
