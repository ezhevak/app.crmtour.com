...
select cost.AccId as AccId,
	...
	concat('Добрый день уважаемый пользователь системы CRM Tour! За предыдущий месяц в системе работало ', ActiveUsers ,'  пользователь(я). Поддержите разработчика и пополните карту Приват банка 5169 3600 2925 4970. Рекомендуемая сумма ',case when ActiveUsers > 3 then ActiveUsers * 100 else ActiveUsers * 120 end, ' грн'
	) as Title,
	0 as Done,
	null as ModelType,
	null as ModelId,
